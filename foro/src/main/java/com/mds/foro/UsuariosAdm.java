...
public class UsuariosAdm extends UsuariosAdm_ventana{
	...
	public UsuariosAdm(com.mds.database.Usuario usu, int i, int posI, com.mds.database.Usuario[] lista) {
		usuario=usu;
	...
	public void desbanearUsuario(Button but, com.mds.database.Usuario usu) {
